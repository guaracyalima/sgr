	...
	<div class="row">
		...
		<div class="small-12 medium-12 large-12 columns">
			...
			<form action="verifica_matricula.php" method="POST" name="" id="">
				<h3>Deseja cancelar a sua reserva de almoço?</h3>
				<label>Informe a sua matricula
					<input type="" name="matricula">
					<button name="reservar"  value="Reservar" id="reservar" class="alert button expanded">Cancelar</button>
