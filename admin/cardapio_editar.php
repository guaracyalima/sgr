...
<?php 
	...
	if (isset($_POST['cadastrar_cardapio']) && $_POST['cadastrar_cardapio'] == 'cad') {
		...
		if (empty($_POST['id_do_cardapio'])) {
			$editar_cardapio = mysql_query("UPDATE cardapio SET ingediente1 = '$ingediente1', ingediente2 = '$ingediente2', ingediente3 = '$ingediente3', ingediente4 = '$ingediente4', ingediente5 = '$ingediente5', ingediente6 = '$ingediente6', data = now(), info = '$info' WHERE id = $id_do_cardapio") or die (mysql_error());
